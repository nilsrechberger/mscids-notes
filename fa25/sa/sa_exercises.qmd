...
```{r}
# Read data
data <- read.csv('./data/husband_wife.csv')
head(data)
```
...
```{r}
mf <- read.csv("./data/husband_wife.csv")
...
```{r}
inc <- read.table("./data/income.dat", header=TRUE)
```
