...
```{r}
data <- read.table("/home/nils/dev/mscids-notes/sp26/rtp/data/kreatin.dat", header=TRUE)
```
...
```{r}
data <- read.table("/home/nils/dev/mscids-notes/sp26/rtp/data/ts_S3_A2.dat", header=TRUE)
```
