...
::: {.callout-tip}
Check out the [Numpy Cheat Sheet](../data/cheat_sheet_numpy.pdf).
:::
...
::: {.callout-tip}
Check out the [Pandas Cheat Sheet](../data/cheat_sheet_pandas.pdf).
:::
...
::: {.callout-tip}
Check out the [Matplotlib Cheat Sheet](../data/cheat_sheet_matplotlib.pdf).
:::
