...
my_range = range(11, 21) # Include boarders
even_digit_numbers = []
...
while ti: # Infinitive loop till break
    # Unsing fake user input
    user_input = randint(1,10)
    trials += 1
    ...
    if user_input == random_number:
        ...
        print("Guess to high...")
    if trials == 4:
        print("Well done - you have tried it 4 times!")
        break
...
```{python}
pyramid  = range(0, 6, 1) # Define upper pattern
